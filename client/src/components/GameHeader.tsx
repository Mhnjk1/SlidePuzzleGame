        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 md:gap-6">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              <h1 className="text-lg md:text-3xl font-bold text-black-900 dark:text-black-100">
                Motion Challenge
              </h1>
              <button
                onClick={toggleTheme}
                className="p-2.5 rounded-full bg-black-200 dark:bg-black-700 hover:bg-black-200 dark:hover:bg-black-600 transition-all"
            ...
            <div className="border-l border-black-300 dark:border-black-600 pl-3 md:pl-4">
              <div className="space-y-0.5">
                <p className="text-m text-black-500 dark:text-black-400">
