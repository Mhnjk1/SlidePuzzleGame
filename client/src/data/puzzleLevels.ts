...
export const puzzleLevels: PuzzleLevel[] = [
  ...
  },
  {
    ...
    gridCols: 5,
    minMoves: 7,
    ballStart: { row: 0, col: 4 },
    ballEnd: { row: 4, col: 0 },
    blocks: [
      { id: 'orange1', row: 1, col: 0, width: 1, height: 3, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue1', row: 0, col: 2, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green1', row: 2, col: 1, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'orange2', row: 3, col: 0, width: 1, height: 2, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 1, col: 2, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 8,
    ...
    ballEnd: { row: 5, col: 5 },
    blocks: [
      { id: 'orange1', row: 1, col: 1, width: 1, height: 3, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue1', row: 0, col: 3, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green1', row: 2, col: 2, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple1', row: 3, col: 3, width: 1, height: 2, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'blue2', row: 4, col: 1, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'orange2', row: 2, col: 4, width: 1, height: 2, color: '#FF9800', orientation: 'vertical', movable: true },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'blue2', row: 3, col: 1, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 4, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 10,
    ...
    blocks: [
      ...
      { id: 'orange2', row: 5, col: 0, width: 1, height: 2, color: '#FF9800', orientation: 'vertical', movable: true },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'blue2', row: 4, col: 0, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green2', row: 5, col: 2, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'gray1', row: 3, col: 4, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 12,
    ...
    blocks: [
      ...
      { id: 'orange2', row: 6, col: 2, width: 1, height: 1, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'green2', row: 5, col: 3, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'gray1', row: 3, col: 2, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    ...
    blocks: [
      ...
      { id: 'blue1', row: 3, col: 4, width: 1, height: 3, color: '#2196F3', orientation: 'vertical', movable: true },
      ...
      { id: 'purple2', row: 5, col: 0, width: 1, height: 2, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 1, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
      { id: 'gray2', row: 2, col: 6, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 14,
    ...
    blocks: [
      { id: 'orange1', row: 1, col: 1, width: 1, height: 4, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue1', row: 0, col: 3, width: 1, height: 3, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green1', row: 2, col: 2, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple1', row: 3, col: 4, width: 1, height: 3, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'blue2', row: 4, col: 2, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'orange2', row: 2, col: 5, width: 1, height: 2, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'green2', row: 5, col: 3, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple2', row: 6, col: 1, width: 1, height: 1, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 3, col: 3, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    ...
    gridCols: 7,
    minMoves: 16,
    ballStart: { row: 3, col: 6 },
    ballEnd: { row: 3, col: 0 },
    blocks: [
      { id: 'orange1', row: 0, col: 2, width: 1, height: 5, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue1', row: 2, col: 3, width: 1, height: 4, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green1', row: 1, col: 4, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple1', row: 4, col: 5, width: 1, height: 2, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'orange2', row: 1, col: 1, width: 1, height: 3, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue2', row: 5, col: 1, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green2', row: 6, col: 3, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple2', row: 0, col: 0, width: 1, height: 2, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 4, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
      { id: 'gray2', row: 2, col: 0, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 16,
    ...
    blocks: [
      ...
      { id: 'orange2', row: 0, col: 2, width: 1, height: 3, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue2', row: 1, col: 4, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green2', row: 5, col: 0, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple2', row: 6, col: 5, width: 1, height: 1, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'orange3', row: 3, col: 0, width: 1, height: 2, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 2, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 17,
    ...
    blocks: [
      ...
      { id: 'orange3', row: 6, col: 1, width: 1, height: 1, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue3', row: 5, col: 3, width: 1, height: 1, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 1, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
      { id: 'gray2', row: 3, col: 6, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    id: 18,
    ...
    ballEnd: { row: 6, col: 0 },
    blocks: [
      { id: 'orange1', row: 1, col: 1, width: 1, height: 6, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue1', row: 3, col: 3, width: 1, height: 4, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green1', row: 2, col: 4, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple1', row: 4, col: 5, width: 1, height: 3, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'orange2', row: 0, col: 2, width: 1, height: 3, color: '#FF9800', orientation: 'vertical', movable: true },
      ...
      { id: 'green2', row: 5, col: 2, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple2', row: 0, col: 0, width: 1, height: 2, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'orange3', row: 6, col: 3, width: 1, height: 1, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue3', row: 3, col: 0, width: 1, height: 2, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 2, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
      { id: 'gray2', row: 2, col: 6, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    ...
    blocks: [
      ...
      { id: 'purple2', row: 4, col: 0, width: 1, height: 3, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'orange3', row: 6, col: 1, width: 1, height: 1, color: '#FF9800', orientation: 'vertical', movable: true },
      { id: 'blue3', row: 6, col: 3, width: 1, height: 1, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green3', row: 5, col: 3, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'gray1', row: 4, col: 1, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
      { id: 'gray2', row: 3, col: 6, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
    ]
  },
  {
    ...
    blocks: [
      ...
      { id: 'blue3', row: 6, col: 3, width: 1, height: 1, color: '#2196F3', orientation: 'vertical', movable: true },
      { id: 'green3', row: 5, col: 3, width: 2, height: 1, color: '#4CAF50', orientation: 'horizontal', movable: true },
      { id: 'purple3', row: 2, col: 0, width: 1, height: 2, color: '#9C27B0', orientation: 'vertical', movable: true },
      { id: 'gray1', row: 4, col: 1, width: 1, height: 1, color: '#BDBDBD', orientation: 'horizontal', movable: false },
